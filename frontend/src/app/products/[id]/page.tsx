            ...
            <ol className="flex items-center space-x-2">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <a href="#" className="ml-2 text-sm font-medium text-gray-500 hover:text-gray-700">Products</a>
                </div>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm font-medium text-gray-500">Product Name</span>
                </div>
              </li>
            </ol>
          </nav>
          ...
          <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="lg:col-start-2 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <div className="space-y-6 text-base text-gray-700">
                  <p>Product description goes here. This is a detailed description of the product features and benefits.</p>
                </div>
              </div>
              ...
              <div className="mt-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-500">In stock and ready to ship</span>
                </div>
              </div>
            ...
            <div className="mt-12 lg:mt-0 lg:col-start-1 lg:row-start-1 lg:self-start">
              ...
              <div className="mt-4 grid grid-cols-4 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="aspect-w-1 aspect-h-1 overflow-hidden rounded-lg">
                    <img
