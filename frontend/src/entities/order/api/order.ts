...
import type { Order, OrderCreate } from '@/entities/order/types/order';

import { orderCreateSchema, orderReadSchema } from '@/entities/order/schemas/order';
import { handleResponse } from '@/shared/api/fetch';
import { ORDER_SERVICE_URL } from '@/shared/config/routes';
